 ...
 * API with ease, alongside built in controllers for health and demo.
 * @class BlockchainPlugin
 * @implements {IPlugin}
 * @extends {BasePlugin}
 * @default
 */
export default class BlockchainPlugin extends BasePlugin implements IPlugin {
	...
	/**
	 * Will initialise the plugin, called usually by the autowire
	 * module to setup.
	...
	public async install(app: Application) {
		...
		console.log('Installing', typeof app);
	}
}
