...
<p align="center">
Sodacore is a bun-powered framework for building server-side applications utilising the lighting fast <a href="https://bun.sh" target="_blank">Bun</a> runtime.<br />The <code>@sodacore/prisma</code> package provides support for the [Prisma ORM](https://www.prisma.io/) and gives support for injecting it into your controllers.
<br/>
<br/>
