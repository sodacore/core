...
<h3 align="center">Sodacore HTTP Plugin</h3>
<p align="center">
Sodacore is a bun-powered framework for building server-side applications utilising the lighting fast <a href="https://bun.sh" target="_blank">Bun</a> runtime.<br />The <code>@sodacore/http</code> package provides a http server that can be used with controllers to create RESTful APIs and more.
<br/>
<br/>
